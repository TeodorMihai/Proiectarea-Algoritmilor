...
public class p1 {
    ...
    /**
     * TODO: 
     * Calculeaza numarul maxim de jucatori daca s-ar adauga o   </br>
    ...
    static void bonus(Graph g) {
        ...
        /*
         * HINT: 
         * 1) Se sorteaza topologic graful aciclic al componentelor tare
         * conexe obtinute si sa retine solutia 
         * 2) Se tine si se updateaza la fiecare pas intr-un vector auxiliar
         * lungimea maxima a unui lant format pana in acel punct din nodurile clusterului, 
         * daca am adauga o legatura artificiala.
         * 
         * Exemplu (dupa efectuarea sortarii topologice): 
         * C1 -> C2 -> C3 C4 -> C5 
         * |____________| |______|
         * 
         * C1..5 sunt noduri ale clusterului (clanuri) 
